...
integer, parameter, public :: &
                      ...
                      RADIOSONDE_SURFACE_ALTIMETER =    36, &
                       DROPSONDE_SURFACE_ALTIMETER =    37, &
                              MARINE_SFC_ALTIMETER =    38, &
                                LAND_SFC_ALTIMETER =    39, &
                                   METAR_ALTIMETER =    40, &
                                       TEMPERATURE =    41, &
                                 SPECIFIC_HUMIDITY =    42, &
                                          PRESSURE =    43, &
                                GPSRO_REFRACTIVITY =    44, &
                           COSMIC_ELECTRON_DENSITY =    45, &
                                          DEWPOINT =    46, &
                                  DEWPOINT_2_METER =    47, &
                                     BUOY_DEWPOINT =    48, &
                                     SHIP_DEWPOINT =    49, &
...
integer, parameter, public :: max_obs_kinds =    70
...
obs_type_info(   36) = obs_type_type(RADIOSONDE_SURFACE_ALTIMETER, &
    'RADIOSONDE_SURFACE_ALTIMETER', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   37) = obs_type_type(DROPSONDE_SURFACE_ALTIMETER, &
    'DROPSONDE_SURFACE_ALTIMETER', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   38) = obs_type_type(MARINE_SFC_ALTIMETER, &
    'MARINE_SFC_ALTIMETER', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   39) = obs_type_type(LAND_SFC_ALTIMETER, &
    'LAND_SFC_ALTIMETER', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   40) = obs_type_type(METAR_ALTIMETER, &
    'METAR_ALTIMETER', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   41) = obs_type_type(TEMPERATURE, &
    'TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   42) = obs_type_type(SPECIFIC_HUMIDITY, &
    'SPECIFIC_HUMIDITY', KIND_SPECIFIC_HUMIDITY, .false., .false.)
obs_type_info(   43) = obs_type_type(PRESSURE, &
    'PRESSURE', KIND_PRESSURE, .false., .false.)
obs_type_info(   44) = obs_type_type(GPSRO_REFRACTIVITY, &
    'GPSRO_REFRACTIVITY', KIND_GPSRO, .false., .false.)
obs_type_info(   45) = obs_type_type(COSMIC_ELECTRON_DENSITY, &
