                         ...
                         PROFILER_V_WIND_COMPONENT =   115, &
                          ...
                          AIRNOW_RELATIVE_HUMIDITY =   135, &
                           ...
                           AIRNOW_V_WIND_COMPONENT =   137, &
                                        ...
                                        PANDA_NMOC =   146, &
                                    PANDA_PRESSURE =   147, &
                                 PANDA_TEMPERATURE =   148, &
                           PANDA_RELATIVE_HUMIDITY =   149, &
                            PANDA_U_WIND_COMPONENT =   150, &
                            PANDA_V_WIND_COMPONENT =   151, &
                                    OMI_NO2_COLUMN =   152, &
                               MODIS_AOD_RETRIEVAL =   153, &
                               MOPITT_CO_RETRIEVAL =   154, &
                                 IASI_CO_RETRIEVAL =   155, &
                                 IASI_O3_RETRIEVAL =   156
                                                                              
                                                                              
integer, parameter, public :: max_obs_kinds =   156
...
obs_type_info(  138) = obs_type_type(PANDA_CO, &
    'PANDA_CO', KIND_CO, .false., .false.)
obs_type_info(  139) = obs_type_type(PANDA_SO2, &
    'PANDA_SO2', KIND_SO2, .false., .false.)
obs_type_info(  140) = obs_type_type(PANDA_NO2, &
    'PANDA_NO2', KIND_NO2, .false., .false.)
obs_type_info(  141) = obs_type_type(PANDA_NOy, &
    'PANDA_NOy', KIND_NOy, .false., .false.)
obs_type_info(  142) = obs_type_type(PANDA_O3, &
    'PANDA_O3', KIND_O3, .false., .false.)
obs_type_info(  143) = obs_type_type(PANDA_PM10, &
    'PANDA_PM10', KIND_PM10, .false., .false.)
obs_type_info(  144) = obs_type_type(PANDA_PM25, &
    'PANDA_PM25', KIND_PM25, .false., .false.)
obs_type_info(  145) = obs_type_type(PANDA_PB, &
    'PANDA_PB', KIND_PB, .false., .false.)
obs_type_info(  146) = obs_type_type(PANDA_NMOC, &
    'PANDA_NMOC', KIND_NMOC, .false., .false.)
obs_type_info(  147) = obs_type_type(PANDA_PRESSURE, &
    'PANDA_PRESSURE', KIND_PRESSURE, .false., .false.)
obs_type_info(  148) = obs_type_type(PANDA_TEMPERATURE, &
    'PANDA_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(  149) = obs_type_type(PANDA_RELATIVE_HUMIDITY, &
    'PANDA_RELATIVE_HUMIDITY', KIND_RELATIVE_HUMIDITY, .false., .false.)
obs_type_info(  150) = obs_type_type(PANDA_U_WIND_COMPONENT, &
    'PANDA_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(  151) = obs_type_type(PANDA_V_WIND_COMPONENT, &
    'PANDA_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(  152) = obs_type_type(OMI_NO2_COLUMN, &
    'OMI_NO2_COLUMN', KIND_NO2, .false., .false.)
obs_type_info(  153) = obs_type_type(MODIS_AOD_RETRIEVAL, &
    'MODIS_AOD_RETRIEVAL', KIND_AOD, .false., .false.)
obs_type_info(  154) = obs_type_type(MOPITT_CO_RETRIEVAL, &
    'MOPITT_CO_RETRIEVAL', KIND_CO, .false., .false.)
obs_type_info(  155) = obs_type_type(IASI_CO_RETRIEVAL, &
    'IASI_CO_RETRIEVAL', KIND_CO, .false., .false.)
obs_type_info(  156) = obs_type_type(IASI_O3_RETRIEVAL, &
