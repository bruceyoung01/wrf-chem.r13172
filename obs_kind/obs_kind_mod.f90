...
integer, parameter, public :: &
                      ...
                      MARINE_SFC_SPECIFIC_HUMIDITY =    23, &
                        ...
                        LAND_SFC_SPECIFIC_HUMIDITY =    28, &
                           ...
                           DOPPLER_RADIAL_VELOCITY =    36, &
                                RADAR_REFLECTIVITY =    37, &
                       RADAR_CLEARAIR_REFLECTIVITY =    38, &
                          PRECIPITATION_FALL_SPEED =    39, &
                             METAR_U_10_METER_WIND =    40, &
                             METAR_V_10_METER_WIND =    41, &
                         METAR_TEMPERATURE_2_METER =    42, &
                   METAR_SPECIFIC_HUMIDITY_2_METER =    43, &
                            METAR_SURFACE_PRESSURE =    44, &
                            METAR_POT_TEMP_2_METER =    45, &
                                          DEWPOINT =    46, &
                                  DEWPOINT_2_METER =    47, &
                                     BUOY_DEWPOINT =    48, &
                                     SHIP_DEWPOINT =    49, &
                                    ...
                                    BOGUS_DEWPOINT =    54, &
                                     AIRS_DEWPOINT =    55, &
                            METAR_DEWPOINT_2_METER =    56, &
                               RADIOSONDE_DEWPOINT =    57, &
                                DROPSONDE_DEWPOINT =    58, &
                                 AIRCRAFT_DEWPOINT =    59, &
                                    ACARS_DEWPOINT =    60, &
                               MARINE_SFC_DEWPOINT =    61, &
                                 LAND_SFC_DEWPOINT =    62, &
                      RADIOSONDE_RELATIVE_HUMIDITY =    63, &
                       DROPSONDE_RELATIVE_HUMIDITY =    64, &
                        AIRCRAFT_RELATIVE_HUMIDITY =    65, &
                           ACARS_RELATIVE_HUMIDITY =    66, &
                      MARINE_SFC_RELATIVE_HUMIDITY =    67, &
                        LAND_SFC_RELATIVE_HUMIDITY =    68, &
                   METAR_RELATIVE_HUMIDITY_2_METER =    69, &
                            AIRS_RELATIVE_HUMIDITY =    70, &
                      RADIOSONDE_SURFACE_ALTIMETER =    71, &
                       DROPSONDE_SURFACE_ALTIMETER =    72, &
                              MARINE_SFC_ALTIMETER =    73, &
                                LAND_SFC_ALTIMETER =    74, &
                                   METAR_ALTIMETER =    75, &
                                       TEMPERATURE =    76, &
                                 SPECIFIC_HUMIDITY =    77, &
                                          PRESSURE =    78, &
                                GPSRO_REFRACTIVITY =    79, &
                           COSMIC_ELECTRON_DENSITY =    80, &
                                        VORTEX_LAT =    81, &
                                        VORTEX_LON =    82, &
                                       VORTEX_PMIN =    83, &
                                       VORTEX_WMAX =    84, &
                             BUOY_U_WIND_COMPONENT =    85, &
                             BUOY_V_WIND_COMPONENT =    86, &
                             BUOY_SURFACE_PRESSURE =    87, &
                                  BUOY_TEMPERATURE =    88, &
                             SHIP_U_WIND_COMPONENT =    89, &
                             SHIP_V_WIND_COMPONENT =    90, &
                             SHIP_SURFACE_PRESSURE =    91, &
                                  SHIP_TEMPERATURE =    92, &
                            SYNOP_U_WIND_COMPONENT =    93, &
                            SYNOP_V_WIND_COMPONENT =    94, &
                            SYNOP_SURFACE_PRESSURE =    95, &
                           SYNOP_SPECIFIC_HUMIDITY =    96, &
                                 SYNOP_TEMPERATURE =    97, &
                            AIREP_U_WIND_COMPONENT =    98, &
                            AIREP_V_WIND_COMPONENT =    99, &
                                    AIREP_PRESSURE =   100, &
                                 AIREP_TEMPERATURE =   101, &
                            AMDAR_U_WIND_COMPONENT =   102, &
                            AMDAR_V_WIND_COMPONENT =   103, &
                                    AMDAR_PRESSURE =   104, &
                                 AMDAR_TEMPERATURE =   105, &
                            PILOT_U_WIND_COMPONENT =   106, &
                            PILOT_V_WIND_COMPONENT =   107, &
                                    PILOT_PRESSURE =   108, &
                                 PILOT_TEMPERATURE =   109, &
                            BOGUS_U_WIND_COMPONENT =   110, &
                            BOGUS_V_WIND_COMPONENT =   111, &
                                    BOGUS_PRESSURE =   112, &
                                 BOGUS_TEMPERATURE =   113, &
                         PROFILER_U_WIND_COMPONENT =   114, &
                         PROFILER_V_WIND_COMPONENT =   115, &
                                 PROFILER_PRESSURE =   116, &
                                   SATEM_THICKNESS =   117, &
                                       MONITOR_SO2 =   118, &
                                       MONITOR_NO2 =   119, &
                                      MONITOR_PM10 =   120, &
                                      ...
                                      MONITOR_PM25 =   123, &
                                       ...
                                       AIRNOW_NMOC =   132, &
                                   AIRNOW_PRESSURE =   133, &
                                AIRNOW_TEMPERATURE =   134, &
                          AIRNOW_RELATIVE_HUMIDITY =   135, &
                           AIRNOW_U_WIND_COMPONENT =   136, &
                           AIRNOW_V_WIND_COMPONENT =   137, &
                                         TOLNET_O3 =   138, &
                                          PANDA_CO =   139, &
                                         PANDA_SO2 =   140, &
                                         PANDA_NO2 =   141, &
                                        ...
                                        PANDA_NMOC =   147, &
                                    PANDA_PRESSURE =   148, &
                                 PANDA_TEMPERATURE =   149, &
                           PANDA_RELATIVE_HUMIDITY =   150, &
                            PANDA_U_WIND_COMPONENT =   151, &
                            PANDA_V_WIND_COMPONENT =   152, &
                                 IASI_CO_RETRIEVAL =   153, &
                                 IASI_O3_RETRIEVAL =   154, &
                                    OMI_NO2_COLUMN =   155, &
                               MOPITT_CO_RETRIEVAL =   156, &
                               MODIS_AOD_RETRIEVAL =   157
                                                                              
                                                                              
integer, parameter, public :: max_obs_kinds =   157
...
obs_type_info(    1) = obs_type_type(RADIOSONDE_U_WIND_COMPONENT, &
    'RADIOSONDE_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(    2) = obs_type_type(RADIOSONDE_V_WIND_COMPONENT, &
    'RADIOSONDE_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(    3) = obs_type_type(RADIOSONDE_GEOPOTENTIAL_HGT, &
    'RADIOSONDE_GEOPOTENTIAL_HGT', KIND_GEOPOTENTIAL_HEIGHT, .false., .false.)
obs_type_info(    4) = obs_type_type(RADIOSONDE_SURFACE_PRESSURE, &
    'RADIOSONDE_SURFACE_PRESSURE', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(    5) = obs_type_type(RADIOSONDE_TEMPERATURE, &
    'RADIOSONDE_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(    6) = obs_type_type(RADIOSONDE_SPECIFIC_HUMIDITY, &
    'RADIOSONDE_SPECIFIC_HUMIDITY', KIND_SPECIFIC_HUMIDITY, .false., .false.)
obs_type_info(    7) = obs_type_type(DROPSONDE_U_WIND_COMPONENT, &
    'DROPSONDE_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(    8) = obs_type_type(DROPSONDE_V_WIND_COMPONENT, &
    'DROPSONDE_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(    9) = obs_type_type(DROPSONDE_SURFACE_PRESSURE, &
    'DROPSONDE_SURFACE_PRESSURE', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   10) = obs_type_type(DROPSONDE_TEMPERATURE, &
    'DROPSONDE_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   11) = obs_type_type(DROPSONDE_SPECIFIC_HUMIDITY, &
    'DROPSONDE_SPECIFIC_HUMIDITY', KIND_SPECIFIC_HUMIDITY, .false., .false.)
obs_type_info(   12) = obs_type_type(AIRCRAFT_U_WIND_COMPONENT, &
    'AIRCRAFT_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(   13) = obs_type_type(AIRCRAFT_V_WIND_COMPONENT, &
    'AIRCRAFT_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(   14) = obs_type_type(AIRCRAFT_TEMPERATURE, &
    'AIRCRAFT_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   15) = obs_type_type(AIRCRAFT_SPECIFIC_HUMIDITY, &
    'AIRCRAFT_SPECIFIC_HUMIDITY', KIND_SPECIFIC_HUMIDITY, .false., .false.)
obs_type_info(   16) = obs_type_type(ACARS_U_WIND_COMPONENT, &
    'ACARS_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(   17) = obs_type_type(ACARS_V_WIND_COMPONENT, &
    'ACARS_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(   18) = obs_type_type(ACARS_TEMPERATURE, &
    'ACARS_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   19) = obs_type_type(ACARS_SPECIFIC_HUMIDITY, &
    'ACARS_SPECIFIC_HUMIDITY', KIND_SPECIFIC_HUMIDITY, .false., .false.)
obs_type_info(   20) = obs_type_type(MARINE_SFC_U_WIND_COMPONENT, &
    'MARINE_SFC_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(   21) = obs_type_type(MARINE_SFC_V_WIND_COMPONENT, &
    'MARINE_SFC_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(   22) = obs_type_type(MARINE_SFC_TEMPERATURE, &
    'MARINE_SFC_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   23) = obs_type_type(MARINE_SFC_SPECIFIC_HUMIDITY, &
    'MARINE_SFC_SPECIFIC_HUMIDITY', KIND_SPECIFIC_HUMIDITY, .false., .false.)
obs_type_info(   24) = obs_type_type(MARINE_SFC_PRESSURE, &
    'MARINE_SFC_PRESSURE', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   25) = obs_type_type(LAND_SFC_U_WIND_COMPONENT, &
    'LAND_SFC_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(   26) = obs_type_type(LAND_SFC_V_WIND_COMPONENT, &
    'LAND_SFC_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(   27) = obs_type_type(LAND_SFC_TEMPERATURE, &
    'LAND_SFC_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   28) = obs_type_type(LAND_SFC_SPECIFIC_HUMIDITY, &
    'LAND_SFC_SPECIFIC_HUMIDITY', KIND_SPECIFIC_HUMIDITY, .false., .false.)
obs_type_info(   29) = obs_type_type(LAND_SFC_PRESSURE, &
    'LAND_SFC_PRESSURE', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   30) = obs_type_type(SAT_U_WIND_COMPONENT, &
    'SAT_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(   31) = obs_type_type(SAT_V_WIND_COMPONENT, &
    'SAT_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(   32) = obs_type_type(ATOV_TEMPERATURE, &
    'ATOV_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   33) = obs_type_type(AIRS_TEMPERATURE, &
    'AIRS_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   34) = obs_type_type(AIRS_SPECIFIC_HUMIDITY, &
    'AIRS_SPECIFIC_HUMIDITY', KIND_SPECIFIC_HUMIDITY, .false., .false.)
obs_type_info(   35) = obs_type_type(GPS_PRECIPITABLE_WATER, &
    'GPS_PRECIPITABLE_WATER', KIND_PRECIPITABLE_WATER, .false., .false.)
obs_type_info(   36) = obs_type_type(DOPPLER_RADIAL_VELOCITY, &
    'DOPPLER_RADIAL_VELOCITY', KIND_VELOCITY, .false., .false.)
obs_type_info(   37) = obs_type_type(RADAR_REFLECTIVITY, &
    'RADAR_REFLECTIVITY', KIND_RADAR_REFLECTIVITY, .false., .false.)
obs_type_info(   38) = obs_type_type(RADAR_CLEARAIR_REFLECTIVITY, &
    'RADAR_CLEARAIR_REFLECTIVITY', KIND_RADAR_REFLECTIVITY, .false., .false.)
obs_type_info(   39) = obs_type_type(PRECIPITATION_FALL_SPEED, &
    'PRECIPITATION_FALL_SPEED', KIND_POWER_WEIGHTED_FALL_SPEED, .false., .false.)
obs_type_info(   40) = obs_type_type(METAR_U_10_METER_WIND, &
    'METAR_U_10_METER_WIND', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(   41) = obs_type_type(METAR_V_10_METER_WIND, &
    'METAR_V_10_METER_WIND', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(   42) = obs_type_type(METAR_TEMPERATURE_2_METER, &
    'METAR_TEMPERATURE_2_METER', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   43) = obs_type_type(METAR_SPECIFIC_HUMIDITY_2_METER, &
    'METAR_SPECIFIC_HUMIDITY_2_METER', KIND_SPECIFIC_HUMIDITY, .false., .false.)
obs_type_info(   44) = obs_type_type(METAR_SURFACE_PRESSURE, &
    'METAR_SURFACE_PRESSURE', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   45) = obs_type_type(METAR_POT_TEMP_2_METER, &
    'METAR_POT_TEMP_2_METER', KIND_POTENTIAL_TEMPERATURE, .false., .false.)
obs_type_info(   46) = obs_type_type(DEWPOINT, &
    'DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   47) = obs_type_type(DEWPOINT_2_METER, &
    'DEWPOINT_2_METER', KIND_DEWPOINT, .false., .false.)
obs_type_info(   48) = obs_type_type(BUOY_DEWPOINT, &
    'BUOY_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   49) = obs_type_type(SHIP_DEWPOINT, &
    'SHIP_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   50) = obs_type_type(SYNOP_DEWPOINT, &
    'SYNOP_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   51) = obs_type_type(AIREP_DEWPOINT, &
    'AIREP_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   52) = obs_type_type(AMDAR_DEWPOINT, &
    'AMDAR_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   53) = obs_type_type(PILOT_DEWPOINT, &
    'PILOT_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   54) = obs_type_type(BOGUS_DEWPOINT, &
    'BOGUS_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   55) = obs_type_type(AIRS_DEWPOINT, &
    'AIRS_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   56) = obs_type_type(METAR_DEWPOINT_2_METER, &
    'METAR_DEWPOINT_2_METER', KIND_DEWPOINT, .false., .false.)
obs_type_info(   57) = obs_type_type(RADIOSONDE_DEWPOINT, &
    'RADIOSONDE_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   58) = obs_type_type(DROPSONDE_DEWPOINT, &
    'DROPSONDE_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   59) = obs_type_type(AIRCRAFT_DEWPOINT, &
    'AIRCRAFT_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   60) = obs_type_type(ACARS_DEWPOINT, &
    'ACARS_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   61) = obs_type_type(MARINE_SFC_DEWPOINT, &
    'MARINE_SFC_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   62) = obs_type_type(LAND_SFC_DEWPOINT, &
    'LAND_SFC_DEWPOINT', KIND_DEWPOINT, .false., .false.)
obs_type_info(   63) = obs_type_type(RADIOSONDE_RELATIVE_HUMIDITY, &
    'RADIOSONDE_RELATIVE_HUMIDITY', KIND_RELATIVE_HUMIDITY, .false., .false.)
obs_type_info(   64) = obs_type_type(DROPSONDE_RELATIVE_HUMIDITY, &
    'DROPSONDE_RELATIVE_HUMIDITY', KIND_RELATIVE_HUMIDITY, .false., .false.)
obs_type_info(   65) = obs_type_type(AIRCRAFT_RELATIVE_HUMIDITY, &
    'AIRCRAFT_RELATIVE_HUMIDITY', KIND_RELATIVE_HUMIDITY, .false., .false.)
obs_type_info(   66) = obs_type_type(ACARS_RELATIVE_HUMIDITY, &
    'ACARS_RELATIVE_HUMIDITY', KIND_RELATIVE_HUMIDITY, .false., .false.)
obs_type_info(   67) = obs_type_type(MARINE_SFC_RELATIVE_HUMIDITY, &
    'MARINE_SFC_RELATIVE_HUMIDITY', KIND_RELATIVE_HUMIDITY, .false., .false.)
obs_type_info(   68) = obs_type_type(LAND_SFC_RELATIVE_HUMIDITY, &
    'LAND_SFC_RELATIVE_HUMIDITY', KIND_RELATIVE_HUMIDITY, .false., .false.)
obs_type_info(   69) = obs_type_type(METAR_RELATIVE_HUMIDITY_2_METER, &
    'METAR_RELATIVE_HUMIDITY_2_METER', KIND_RELATIVE_HUMIDITY, .false., .false.)
obs_type_info(   70) = obs_type_type(AIRS_RELATIVE_HUMIDITY, &
    'AIRS_RELATIVE_HUMIDITY', KIND_RELATIVE_HUMIDITY, .false., .false.)
obs_type_info(   71) = obs_type_type(RADIOSONDE_SURFACE_ALTIMETER, &
    'RADIOSONDE_SURFACE_ALTIMETER', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   72) = obs_type_type(DROPSONDE_SURFACE_ALTIMETER, &
    'DROPSONDE_SURFACE_ALTIMETER', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   73) = obs_type_type(MARINE_SFC_ALTIMETER, &
    'MARINE_SFC_ALTIMETER', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   74) = obs_type_type(LAND_SFC_ALTIMETER, &
    'LAND_SFC_ALTIMETER', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   75) = obs_type_type(METAR_ALTIMETER, &
    'METAR_ALTIMETER', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   76) = obs_type_type(TEMPERATURE, &
    'TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   77) = obs_type_type(SPECIFIC_HUMIDITY, &
    'SPECIFIC_HUMIDITY', KIND_SPECIFIC_HUMIDITY, .false., .false.)
obs_type_info(   78) = obs_type_type(PRESSURE, &
    'PRESSURE', KIND_PRESSURE, .false., .false.)
obs_type_info(   79) = obs_type_type(GPSRO_REFRACTIVITY, &
    'GPSRO_REFRACTIVITY', KIND_GPSRO, .false., .false.)
obs_type_info(   80) = obs_type_type(COSMIC_ELECTRON_DENSITY, &
    'COSMIC_ELECTRON_DENSITY', KIND_ELECTRON_DENSITY, .false., .false.)
obs_type_info(   81) = obs_type_type(VORTEX_LAT, &
    'VORTEX_LAT', KIND_VORTEX_LAT, .false., .false.)
obs_type_info(   82) = obs_type_type(VORTEX_LON, &
    'VORTEX_LON', KIND_VORTEX_LON, .false., .false.)
obs_type_info(   83) = obs_type_type(VORTEX_PMIN, &
    'VORTEX_PMIN', KIND_VORTEX_PMIN, .false., .false.)
obs_type_info(   84) = obs_type_type(VORTEX_WMAX, &
    'VORTEX_WMAX', KIND_VORTEX_WMAX, .false., .false.)
obs_type_info(   85) = obs_type_type(BUOY_U_WIND_COMPONENT, &
    'BUOY_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(   86) = obs_type_type(BUOY_V_WIND_COMPONENT, &
    'BUOY_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(   87) = obs_type_type(BUOY_SURFACE_PRESSURE, &
    'BUOY_SURFACE_PRESSURE', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   88) = obs_type_type(BUOY_TEMPERATURE, &
    'BUOY_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   89) = obs_type_type(SHIP_U_WIND_COMPONENT, &
    'SHIP_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(   90) = obs_type_type(SHIP_V_WIND_COMPONENT, &
    'SHIP_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(   91) = obs_type_type(SHIP_SURFACE_PRESSURE, &
    'SHIP_SURFACE_PRESSURE', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   92) = obs_type_type(SHIP_TEMPERATURE, &
    'SHIP_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   93) = obs_type_type(SYNOP_U_WIND_COMPONENT, &
    'SYNOP_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(   94) = obs_type_type(SYNOP_V_WIND_COMPONENT, &
    'SYNOP_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(   95) = obs_type_type(SYNOP_SURFACE_PRESSURE, &
    'SYNOP_SURFACE_PRESSURE', KIND_SURFACE_PRESSURE, .false., .false.)
obs_type_info(   96) = obs_type_type(SYNOP_SPECIFIC_HUMIDITY, &
    'SYNOP_SPECIFIC_HUMIDITY', KIND_SPECIFIC_HUMIDITY, .false., .false.)
obs_type_info(   97) = obs_type_type(SYNOP_TEMPERATURE, &
    'SYNOP_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(   98) = obs_type_type(AIREP_U_WIND_COMPONENT, &
    'AIREP_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(   99) = obs_type_type(AIREP_V_WIND_COMPONENT, &
    'AIREP_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(  100) = obs_type_type(AIREP_PRESSURE, &
    'AIREP_PRESSURE', KIND_PRESSURE, .false., .false.)
obs_type_info(  101) = obs_type_type(AIREP_TEMPERATURE, &
    'AIREP_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(  102) = obs_type_type(AMDAR_U_WIND_COMPONENT, &
    'AMDAR_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(  103) = obs_type_type(AMDAR_V_WIND_COMPONENT, &
    'AMDAR_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(  104) = obs_type_type(AMDAR_PRESSURE, &
    'AMDAR_PRESSURE', KIND_PRESSURE, .false., .false.)
obs_type_info(  105) = obs_type_type(AMDAR_TEMPERATURE, &
    'AMDAR_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(  106) = obs_type_type(PILOT_U_WIND_COMPONENT, &
    'PILOT_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(  107) = obs_type_type(PILOT_V_WIND_COMPONENT, &
    'PILOT_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(  108) = obs_type_type(PILOT_PRESSURE, &
    'PILOT_PRESSURE', KIND_PRESSURE, .false., .false.)
obs_type_info(  109) = obs_type_type(PILOT_TEMPERATURE, &
    'PILOT_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(  110) = obs_type_type(BOGUS_U_WIND_COMPONENT, &
    'BOGUS_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(  111) = obs_type_type(BOGUS_V_WIND_COMPONENT, &
    'BOGUS_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(  112) = obs_type_type(BOGUS_PRESSURE, &
    'BOGUS_PRESSURE', KIND_PRESSURE, .false., .false.)
obs_type_info(  113) = obs_type_type(BOGUS_TEMPERATURE, &
    'BOGUS_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(  114) = obs_type_type(PROFILER_U_WIND_COMPONENT, &
    'PROFILER_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(  115) = obs_type_type(PROFILER_V_WIND_COMPONENT, &
    'PROFILER_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(  116) = obs_type_type(PROFILER_PRESSURE, &
    'PROFILER_PRESSURE', KIND_PRESSURE, .false., .false.)
obs_type_info(  117) = obs_type_type(SATEM_THICKNESS, &
    'SATEM_THICKNESS', KIND_TEMPERATURE, .false., .false.)
obs_type_info(  118) = obs_type_type(MONITOR_SO2, &
    'MONITOR_SO2', KIND_SO2, .false., .false.)
obs_type_info(  119) = obs_type_type(MONITOR_NO2, &
    'MONITOR_NO2', KIND_NO2, .false., .false.)
obs_type_info(  120) = obs_type_type(MONITOR_PM10, &
    'MONITOR_PM10', KIND_PM10, .false., .false.)
obs_type_info(  121) = obs_type_type(MONITOR_CO, &
    'MONITOR_CO', KIND_CO, .false., .false.)
obs_type_info(  122) = obs_type_type(MONITOR_O3, &
    'MONITOR_O3', KIND_O3, .false., .false.)
obs_type_info(  123) = obs_type_type(MONITOR_PM25, &
    'MONITOR_PM25', KIND_PM25, .false., .false.)
obs_type_info(  124) = obs_type_type(AIRNOW_CO, &
    'AIRNOW_CO', KIND_CO, .false., .false.)
obs_type_info(  125) = obs_type_type(AIRNOW_SO2, &
    'AIRNOW_SO2', KIND_SO2, .false., .false.)
obs_type_info(  126) = obs_type_type(AIRNOW_NO2, &
    'AIRNOW_NO2', KIND_NO2, .false., .false.)
obs_type_info(  127) = obs_type_type(AIRNOW_NOy, &
    'AIRNOW_NOy', KIND_NOy, .false., .false.)
obs_type_info(  128) = obs_type_type(AIRNOW_O3, &
    'AIRNOW_O3', KIND_O3, .false., .false.)
obs_type_info(  129) = obs_type_type(AIRNOW_PM10, &
    'AIRNOW_PM10', KIND_PM10, .false., .false.)
obs_type_info(  130) = obs_type_type(AIRNOW_PM25, &
    'AIRNOW_PM25', KIND_PM25, .false., .false.)
obs_type_info(  131) = obs_type_type(AIRNOW_PB, &
    'AIRNOW_PB', KIND_PB, .false., .false.)
obs_type_info(  132) = obs_type_type(AIRNOW_NMOC, &
    'AIRNOW_NMOC', KIND_NMOC, .false., .false.)
obs_type_info(  133) = obs_type_type(AIRNOW_PRESSURE, &
    'AIRNOW_PRESSURE', KIND_PRESSURE, .false., .false.)
obs_type_info(  134) = obs_type_type(AIRNOW_TEMPERATURE, &
    'AIRNOW_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(  135) = obs_type_type(AIRNOW_RELATIVE_HUMIDITY, &
    'AIRNOW_RELATIVE_HUMIDITY', KIND_RELATIVE_HUMIDITY, .false., .false.)
obs_type_info(  136) = obs_type_type(AIRNOW_U_WIND_COMPONENT, &
    'AIRNOW_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(  137) = obs_type_type(AIRNOW_V_WIND_COMPONENT, &
    'AIRNOW_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(  138) = obs_type_type(TOLNET_O3, &
    'TOLNET_O3', KIND_O3, .false., .false.)
obs_type_info(  139) = obs_type_type(PANDA_CO, &
    'PANDA_CO', KIND_CO, .false., .false.)
obs_type_info(  140) = obs_type_type(PANDA_SO2, &
    'PANDA_SO2', KIND_SO2, .false., .false.)
obs_type_info(  141) = obs_type_type(PANDA_NO2, &
    'PANDA_NO2', KIND_NO2, .false., .false.)
obs_type_info(  142) = obs_type_type(PANDA_NOy, &
    'PANDA_NOy', KIND_NOy, .false., .false.)
obs_type_info(  143) = obs_type_type(PANDA_O3, &
    'PANDA_O3', KIND_O3, .false., .false.)
obs_type_info(  144) = obs_type_type(PANDA_PM10, &
    'PANDA_PM10', KIND_PM10, .false., .false.)
obs_type_info(  145) = obs_type_type(PANDA_PM25, &
    'PANDA_PM25', KIND_PM25, .false., .false.)
obs_type_info(  146) = obs_type_type(PANDA_PB, &
    'PANDA_PB', KIND_PB, .false., .false.)
obs_type_info(  147) = obs_type_type(PANDA_NMOC, &
    'PANDA_NMOC', KIND_NMOC, .false., .false.)
obs_type_info(  148) = obs_type_type(PANDA_PRESSURE, &
    'PANDA_PRESSURE', KIND_PRESSURE, .false., .false.)
obs_type_info(  149) = obs_type_type(PANDA_TEMPERATURE, &
    'PANDA_TEMPERATURE', KIND_TEMPERATURE, .false., .false.)
obs_type_info(  150) = obs_type_type(PANDA_RELATIVE_HUMIDITY, &
    'PANDA_RELATIVE_HUMIDITY', KIND_RELATIVE_HUMIDITY, .false., .false.)
obs_type_info(  151) = obs_type_type(PANDA_U_WIND_COMPONENT, &
    'PANDA_U_WIND_COMPONENT', KIND_U_WIND_COMPONENT, .false., .false.)
obs_type_info(  152) = obs_type_type(PANDA_V_WIND_COMPONENT, &
    'PANDA_V_WIND_COMPONENT', KIND_V_WIND_COMPONENT, .false., .false.)
obs_type_info(  153) = obs_type_type(IASI_CO_RETRIEVAL, &
    'IASI_CO_RETRIEVAL', KIND_CO, .false., .false.)
obs_type_info(  154) = obs_type_type(IASI_O3_RETRIEVAL, &
    'IASI_O3_RETRIEVAL', KIND_O3, .false., .false.)
obs_type_info(  155) = obs_type_type(OMI_NO2_COLUMN, &
    'OMI_NO2_COLUMN', KIND_NO2, .false., .false.)
obs_type_info(  156) = obs_type_type(MOPITT_CO_RETRIEVAL, &
    'MOPITT_CO_RETRIEVAL', KIND_CO, .false., .false.)
obs_type_info(  157) = obs_type_type(MODIS_AOD_RETRIEVAL, &
    'MODIS_AOD_RETRIEVAL', KIND_AOD, .false., .false.)
