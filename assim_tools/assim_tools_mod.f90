...
!>@todo FIXME this block is responsible for bitwise differences WRT trunk
! r2216             ens_var_deflate = ens_obs_var / &
! r2216                (1.0_r8 + gamma*(sqrt(ss_inflate_base) - 1.0_r8))**2
!>@todo FIXME this block is responsible for bitwise differences WRT trunk
