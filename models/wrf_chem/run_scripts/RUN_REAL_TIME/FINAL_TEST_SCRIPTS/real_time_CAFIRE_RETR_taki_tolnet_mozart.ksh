...
#
# ROOT DIRECTORIES:
export SCRATCH_DIR=/home/vy57456/zzbatmos_user/data/dart/CAFIRE_MOZART
export MODEL_DIR=/home/vy57456/zzbatmos_user/model/gfortran/MPI
export INPUT_DATA_DIR=/home/vy57456/zzbatmos_user/data/dart/CAFIRE_MOZART
#
# DEPENDENT INPUT DATA DIRECTORIES:
export EXPERIMENT_DIR=${SCRATCH_DIR}
export RUN_DIR=${EXPERIMENT_DIR}/real_CAFIRE_RETR_VARLOC
...
export NL_J_PARENT_START=${JSTR_CR},${JSTR_FR}
export NL_PARENT_GRID_RATIO=1,3
export NL_PARENT_TIME_STEP_RATIO=1,3 #1,2
