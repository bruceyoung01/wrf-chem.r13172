...
export WRFINP_FR=wrfinput_d03_${YEAR}-${MONTH}-${DAY}_${HOUR}:00:00
cp ${METDIR}/${WRFINP_FR} ./.
mv ${WRFINP_FR} wrfinput_d03_${YEAR}-${MONTH}-${DAY}_${HOUR}:00:00.e000
...
mv wrfinput_d03_${YEAR}-${MONTH}-${DAY}_${HOUR}:00:00.e000 ${WRFINP_FR}
